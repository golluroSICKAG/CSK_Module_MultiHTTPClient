...
function multiHTTPClient.create(multiHTTPClientInstanceNo)
  ...
  self.multiHTTPClientProcessingParams:add('registeredEvent', self.parameters.registeredEvent, "STRING")
  --self.multiHTTPClientProcessingParams:add('showImage', self.parameters.showImage, "BOOL")
  --self.multiHTTPClientProcessingParams:add('viewerId', 'multiHTTPClientViewer' .. self.multiHTTPClientInstanceNoString, "STRING")

  --self.multiHTTPClientProcessingParams:add('internalObjects', internalObjectContainer, "OBJECT") -- optionally
  --self.multiHTTPClientProcessingParams:add('selectedObject', self.parameters.selectedObject, "INT")
